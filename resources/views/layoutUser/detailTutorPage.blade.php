                            ...
                            <div class="col-md-6 card-container">
                                <div class="card mb-3 testimonial-card">
                                    <div class="card-body">
                                        ...
                                        <p class="mt-3" style="font-size: 14px">John's review about the tutor goes here. It's a great experience!
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 card-container">
                                <div class="card mb-3 testimonial-card">
                                    <div class="card-body">
                                        ...
                                        <p class="mt-3" style="font-size: 14px">Jane's review about the tutor goes here. I learned a lot!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
