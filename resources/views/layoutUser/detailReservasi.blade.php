            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card-header-profilTutor">
                        <div class="card-body">
                            <h5 class="card-title-search" style="margin-left: 30px">Detail Reservasi</h5>
                        </div>
                    </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="deskripsiTutorA">
                                    <div class="card-body-tutorA">
                                        <h4 class="card-tutorA">Paket A</h4>
                                        <h6 class="card-tutor-p">Deskripsi</h6>
                                        <h6 class="card-tutor-p">Harga</h6>
                                        <h6 class="card-tutor-p">Nama Tutor</h6>
                                    </div>
                                </div>
                            </div>
