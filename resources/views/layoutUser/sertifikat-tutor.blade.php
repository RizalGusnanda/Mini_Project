                    ...
                    <div class="card-formulir-sertifikasi">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="penjelasan_pengalaman">Deskripsi Tutor</label>
                                <textarea class="form-control" id="summernote" name="penjelasan_pengalaman" cols="30"
                                    rows="10">{{ old('penjelasan_pengalaman', optional(auth()->user()->profile)->penjelasan_pengalaman) }}</textarea>
                            </div>
                        </div>
                        <br>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="pengalaman">Sertifikat Penunjang</label>
                                <div class="sertifikasi-group card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="deskripsi_sertifikasi">Deskripsi Sertifikat</label>
                                                <textarea class="form-control" id="deskripsi_sertifikasi_{{ $loop->index }}" name="deskripsi_sertifikasi[]" cols="20"
                                                    >{{ old('deskripsi_sertifikasi', $sertifikat->deskripsi_sertifikasi) }}</textarea>
                                                <!-- Input tersembunyi untuk ID deskripsi_sertifikat yang sudah ada -->
                                                <input type="hidden" name="deskripsi_sertifikat_id[]"
                                                    value="{{ $sertifikat->id }}">
                                            </div>
                                            <div class="form-group">
            ...
            newSertifikasi.innerHTML = `
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control"
                            id="link_${sertifikasiCount}" name="link[]"
                            placeholder="drive.google.com">
                    </div>
                </div>
                <button class="btn btn-sm btn-danger btn-icon confirm-delete"
                    data-sertifikat-id="${sertifikasiCount}">
                    <i class="fas fa-times"></i> Hapus
                </button>
            `;
