        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card-menu">
                        <div class="menu">
                            ...
                            <a href="/kelas-guru" style="text-decoration: none; color: black">
                                <div class="menu-item">
                                    <i class="fas fa-graduation-cap"></i>
                ...
                <div class="col-md-8">
                    ...
                    <form method="post" action="{{ route('simpan-modul') }}">
                        @csrf
                        <div class="card-formulir-modul">
                            <!-- Input paket_id sebagai field tersembunyi (hidden field) -->
                            <!-- Input paket_id sebagai field tersembunyi (hidden field) -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="modul-group card custom-card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <input type="hidden" name="paket_id" value="{{ request()->query('paket_id') }}">

                                                <label for="">Judul Modul</label>
                                                <input type="text" class="form-control" name="nama_modul"
                                                    id="nama_modul">
                                                <label for="">Deskripsi Modul:</label>
                                                <textarea name="deskripsi_modul" id="deskripsi_modul" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
