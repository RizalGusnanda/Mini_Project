        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <form method="post" action="{{ route('simpan-modul', ['id' => $modul->id]) }}">
                        @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="modul-group card custom-card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <input type="hidden" name="paket_id" value="{{ $modul }}">

                                                <label for="">Judul Modul</label>
                                                <input type="text" class="form-control" name="nama_modul"
                                                    id="nama_modul">
                                                <label for="">Deskripsi Modul:</label>
                                                <textarea name="deskripsi_modul" id="summernote" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
